...
def gen_possible_schedules(database, program, semester='fall', fload=5, wload=5): # should also take, semester that one starts from and completed courses
...
def optimal_schedule(course_database, program, ratings, f='quality'):
    ...
    try:
	url = get_vsb_url(course_database, o)
    except:
	url = "None, sorry"
